...
return new \Phalcon\Config([
    ...
    'loto_infos' => [
        ...
        'scraping_info' => [
            'table_element'        => "div.inner table.typeTK:eq(0)",
            'event_number_element' => ".alnCenter.bgf7f7f7.js-lottery-issue-pc",
            'event_date_element'   => ".alnCenter.js-lottery-date-pc",
            'loto_number_element'  => ".js-lottery-number-pc:eq(%num%)",
            'bonus_number_element' => ".js-lottery-bonus-pc:eq(%num%)",
        ],
        'reply_count' => 5, // １回で返すのが５口分
    ],
    'past_loto_infos' => [
        '5'  => [
            'url'            => "https://www.mizuhobank.co.jp/retail/takarakuji/loto/miniloto/index.html",
            ...
            'config'         => [
                [
                    'type'      => '1',
                    'url'       => 'https://www.mizuhobank.co.jp/retail/takarakuji/loto/backnumber/loto0%num%.html',
                    'start_num' => 1,
                    'end_num'   => 501,
                    'add_cnt'   => 20,
                    'scraping_info' => [
                ...
                [
                    'type'      => '2',
                    'url'       => 'https://www.mizuhobank.co.jp/retail/takarakuji/loto/backnumber/detail.html?fromto=%num1%_%num2%&type=miniloto',
                    'start_num' => 521,
                    'end_num1'  => 921,
                    'end_num2'  => 925,
                    'add_cnt'   => 20,
                    'scraping_info' => [
                        ...
                        'event_date_element'   => "td.alnRight:eq(%num%)",
                        'loto_number_element'  => "tr:eq(%num1%) td:eq(%num2%)",
                        'bonus_number_element' => "tr:eq(%num1%) .alnCenter.green:eq(%num2%)",
                        //'bonus_number_element' => "tr:eq(%num%) .alnCenter.green",
                    ],
                ],
                [
                    'type'       => '3',
                    'url'        => 'https://www.mizuhobank.co.jp/retail/takarakuji/loto/miniloto/index.html?year=%num1%&month=%num2%',
                    'start_date' => [
                        'year'     => '2017',
                        'month'    => '6',
                    ],
                    ...
                    'scraping_info' => [
                        ...
                        'event_date_element'   => ".alnCenter.js-lottery-date-pc",
                        'loto_number_element'  => ".js-lottery-number-pc:eq(%num%)",
                        'bonus_number_element' => "tr:eq(%num1%) .alnCenter.extension.green:eq(%num2%)",
        ...
        '7'  => [
            ...
            'config'         => [
                [
                    'type'      => '2',
                    'url'       => 'https://www.mizuhobank.co.jp/retail/takarakuji/loto/backnumber/detail.html?fromto=%num1%_%num2%&type=loto7',
                    'start_num' => 1,
                    'end_num1'  => 201,
                    'end_num2'  => 214,
                    'add_cnt'   => 20,
                ...
                [
                    'type'       => '3',
                    'url'        => 'https://www.mizuhobank.co.jp/retail/takarakuji/loto/loto7/index.html?year=%num1%&month=%num2%',
                    'start_date' => [
                        'year'     => '2017',
                        'month'    => '6',
                    ],
